...
if [[ $push_images ]]; then
  ...
  services=(basket.api catalog.api discount.api identity.api ordering.api payment.api webmvc webspa webstatus)
...
charts=(eshop-common basket-api catalog-api discount-api identity-api mobileshoppingagg ordering-api ordering-backgroundtasks ordering-signalrhub payment-api webmvc webshoppingagg webspa webstatus webhooks-api webhooks-web)
