...
public class DiscountContextSeed
{
    ...
    //private IEnumerable<CatalogBrand> GetCatalogBrandsFromFile(string contentRootPath, ILogger<DiscountContextSeed> logger)
    //{
    ...
    //private IEnumerable<CatalogType> GetCatalogTypesFromFile(string contentRootPath, ILogger<DiscountContextSeed> logger)
    //{
    ...
    //private IEnumerable<CatalogItem> GetCatalogItemsFromFile(string contentRootPath, CatalogContext context, ILogger<DiscountContextSeed> logger)
    //{
