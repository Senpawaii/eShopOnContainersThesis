...
public class CoordinatorService : ICoordinatorService {
    ...
    public async Task SendTokens() {
        ...
        _logger.LogInformation($"ClientID: {_metadata.ClientID}, Sending {tokensToSend} tokens to coordinator at {DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")}");
