...
public class CoordinatorService : ICoordinatorService {
    ...
    public async Task SendEventTokens() {
        int tokensToSend = _metadata.Tokens.Value;
        string uri = $"{_settings.Value.CoordinatorUrl}eventtokens?tokens={tokensToSend}&clientID={_metadata.ClientID.Value}&serviceName=BasketService";
