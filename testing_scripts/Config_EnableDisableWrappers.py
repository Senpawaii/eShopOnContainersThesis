...
file_path = [os.path.join(current_directory, 'src\\Services\\Catalog\\Catalog.API\\appsettings.json'), os.path.join(current_directory, 'src\\Services\\Discount\\Discount.API\\appsettings.json'), os.path.join(current_directory, 'src\\Web\\WebMVC\\appsettings.json')]
services = ['Catalog', 'Discount', 'WebMVC']
